...
$data['nav'] = $base_path . $file_loc['html_snippet']['nav']['login'];
...
$data['content'] = $base_path . $file_loc['html_snippet']['form']['login'];
$data['send_form_to'] = $base_path . $file_loc['script']['login'];
